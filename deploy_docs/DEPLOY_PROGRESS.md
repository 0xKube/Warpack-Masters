...
- Crafting recipe seeded: `scripts/init_add_recipes.sh release` (tx `0x056d839a138d3328c0ba842656d58ffb065e91412a29c262d31d2bd80eb4da75`) — 2x Dagger (id 6) + 1x Herb (id 5) → Augmented Dagger (id 15).
