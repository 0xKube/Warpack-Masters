...
//         let mut items_length = append_item(ref items_cooldown4, ref items_cooldown5, ref
//         items_cooldown6, ref items_cooldown7, 1, PLAYER, 4, 0);
...
//         items_length = append_item(ref items_cooldown4, ref items_cooldown5, ref items_cooldown6,
//         ref items_cooldown7, 2, DUMMY, 5, items_length);
...
//         items_length = append_item(ref items_cooldown4, ref items_cooldown5, ref items_cooldown6,
//         ref items_cooldown7, 1, DUMMY, 4, items_length);
...
//         append_item(ref items_cooldown4, ref items_cooldown5, ref items_cooldown6, ref
//         items_cooldown7, 1, PLAYER, 1, 0);
//     }
...
//         append_item(ref items_cooldown4, ref items_cooldown5, ref items_cooldown6, ref
//         items_cooldown7, 1, PLAYER, 4, 0);
//         append_item(ref items_cooldown4, ref items_cooldown5, ref items_cooldown6, ref
//         items_cooldown7, 2, DUMMY, 5, 1);
//         append_item(ref items_cooldown4, ref items_cooldown5, ref items_cooldown6, ref
//         items_cooldown7, 1, DUMMY, 4, 2);

//         let (item_ids, belongs_tos) = combine_items(ref items_cooldown4, ref items_cooldown5, ref
//         items_cooldown6, ref items_cooldown7);
