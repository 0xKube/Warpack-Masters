...
pub trait ITokenFactory<TContractState> {
    ...
    fn batch_create_tokens_for_items(
        ref self: TContractState, owner: ContractAddress, erc20_class_hash: ClassHash,
    );
    fn create_gold_token(
        ref self: TContractState,
        admin: ContractAddress,
        minter: ContractAddress,
        upgrade: ContractAddress,
        erc20_class_hash: ClassHash,
    ) -> ContractAddress;
...
pub mod token_factory {
    ...
    use warpack_masters::constants::constants::{GOLD_ITEM_ID, TOKEN_SUPPLY_BASE};
    ...
    let token_registry = TokenRegistry {
        ...
        fn create_token_for_item(
            ...
            let (token_address, _) = deploy_syscall(
                erc20_class_hash, 0, // salt
                constructor_calldata.span(), false,
            )
                .unwrap();
        ...
        fn batch_create_tokens_for_items(
            ref self: ContractState, owner: ContractAddress, erc20_class_hash: ClassHash,
        ) {
            let mut world = self.world(@"Warpacks");
            ...
            self
                .create_token_for_item(
                    items::Pack::id, items::Pack::name(), "PACK", owner, erc20_class_hash,
                );

            // Item 3: Satchel
            self
                .create_token_for_item(
                    items::Satchel::id, items::Satchel::name(), "SATCHEL", owner, erc20_class_hash,
                );

            // Item 4: Pouch
            self
                .create_token_for_item(
                    items::Pouch::id, items::Pouch::name(), "POUCH", owner, erc20_class_hash,
                );

            // Item 5: Herb
            self
                .create_token_for_item(
                    items::Herb::id, items::Herb::name(), "HERB", owner, erc20_class_hash,
                );

            // Item 6: Dagger
            self
                .create_token_for_item(
                    items::Dagger::id, items::Dagger::name(), "DAGGER", owner, erc20_class_hash,
                );

            // Item 7: Sword
            self
                .create_token_for_item(
                    items::Sword::id, items::Sword::name(), "SWORD", owner, erc20_class_hash,
                );

            // Item 8: Spike
            self
                .create_token_for_item(
                    items::Spike::id, items::Spike::name(), "SPIKE", owner, erc20_class_hash,
                );

            // Item 9: Shield
            self
                .create_token_for_item(
                    items::Shield::id, items::Shield::name(), "SHIELD", owner, erc20_class_hash,
                );

            // Item 10: Helmet
            self
                .create_token_for_item(
                    items::Helmet::id, items::Helmet::name(), "HELMET", owner, erc20_class_hash,
                );
            ...
            self
                .create_token_for_item(
                    items::Poison::id, items::Poison::name(), "POISON", owner, erc20_class_hash,
                );
            ...
            self
                .create_token_for_item(
                    items::Buckler::id, items::Buckler::name(), "BUCKLER", owner, erc20_class_hash,
                );
            ...
            self
                .create_token_for_item(
                    items::Bow::id, items::Bow::name(), "BOW", owner, erc20_class_hash,
                );
            ...
            self
                .create_token_for_item(
                    items::Hammer::id, items::Hammer::name(), "HAMMER", owner, erc20_class_hash,
                );
            ...
            self
                .create_token_for_item(
                    items::Club::id, items::Club::name(), "CLUB", owner, erc20_class_hash,
                );

            // Item 31: Fang
            self
                .create_token_for_item(
                    items::Fang::id, items::Fang::name(), "FANG", owner, erc20_class_hash,
                );
            ...
            self
                .create_token_for_item(
                    items::Longbow::id, items::Longbow::name(), "LONGBOW", owner, erc20_class_hash,
                );
        }
