...
mod tests {
    ...
    use warpack_masters::models::CharacterItem::{
        InventoryCounter, CharacterItemInventory, m_InventoryCounter, m_InventoryItem,
    ...
    fn test_move_item_from_shop_to_inventory_revert_grid_occupied() {
        ...
        // Place first item
        action_system
            .move_item_from_shop_to_inventory(
                7, 4, 2, 0,
            ); // sword at (4,2) occupies (4,2), (4,3), (4,4)
        ...
        action_system
            .move_item_from_shop_to_inventory(8, 4, 2, 0); // Should fail because (4,2) is occupied
    }
}
