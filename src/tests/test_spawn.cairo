...
mod tests {
    ...
    use warpack_masters::constants::constants::{INIT_GOLD, INIT_HEALTH, INIT_STAMINA};
    use warpack_masters::externals::erc20_mintable::MintableERC20Token;
    ...
    use warpack_masters::models::CharacterItem::{
        InventoryCounter, StorageCounter, CharacterItemInventory, CharacterItemStorage,
        m_InventoryCounter, m_StorageCounter, m_CharacterItemInventory, m_CharacterItemStorage,
    };
    ...
    fn create_gold_token(world: WorldStorage, deployer: ContractAddress) -> ContractAddress {
        ...
        let token_address = token_factory
            .create_gold_token(
                ...
                deployer,
                deployer,
                MintableERC20Token::TEST_CLASS_HASH.try_into().unwrap(),
            );
    ...
    fn test_name_already_exists() {
        ...
        let bob = warpack_masters::utils::address::address_from(0x2);
