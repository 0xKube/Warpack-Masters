...
mod tests {
    ...
    use warpack_masters::models::Character::{m_Character, m_CharacterName};
    use warpack_masters::models::CharacterItem::{
        m_InventoryCounter, m_InventoryItem, m_StorageCounter, m_StorageItem,
    };
    use warpack_masters::models::Item::{Item, ItemsCounter, m_Item, m_ItemsCounter};
    use warpack_masters::models::Shop::m_Shop;
    use warpack_masters::models::backpack::m_BackpackGrids;
    use warpack_masters::systems::actions::actions;
    use warpack_masters::systems::item::{IItemDispatcher, IItemDispatcherTrait, item_system};
    use warpack_masters::systems::shop::shop_system;
    ...
    fn test_add_item() {
        ...
        assert(
            item_six_data.effectStacks == items::Dagger::effectStacks, 'I6 effectStacks mismatch',
        );
        assert(
            item_six_data.effectActivationType == items::Dagger::effectActivationType,
            'ActivationType mismatch',
        );
        ...
        assert(
            item_nine_data.effectStacks == items::Shield::effectStacks, 'I9 effectStacks mismatch',
        );
        assert(
            item_nine_data.effectActivationType == items::Shield::effectActivationType,
            'ActivationType mismatch',
        );
        ...
        assert(
            item_eleven_data.effectType == items::HealingPotion::effectType,
            'I11 effectType mismatch',
        );
        assert(
            item_eleven_data.effectStacks == items::HealingPotion::effectStacks,
            'I11 effectStacks mismatch',
        );
        assert(
            item_eleven_data.effectActivationType == items::HealingPotion::effectActivationType,
            'ActivationType mismatch',
        );
        ...
        assert(
            item_eleven_data.isPlugin == items::HealingPotion::isPlugin, 'I11 isPlugin mismatch',
        );
        ...
        assert(
            item_fifteen_data.effectType == items::AugmentedDagger::effectType,
            'I15 effectType mismatch',
        );
        assert(
            item_fifteen_data.effectStacks == items::AugmentedDagger::effectStacks,
            'I15 effectStacks mismatch',
        );
        assert(
            item_fifteen_data.effectActivationType == items::AugmentedDagger::effectActivationType,
            'ActivationType mismatch',
        );
        ...
        assert(
            item_fifteen_data.isPlugin == items::AugmentedDagger::isPlugin, 'I15 isPlugin mismatch',
        );
    }
