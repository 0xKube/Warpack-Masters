...
mod tests {
    ...
    fn test_move_item_from_storage_to_inventory() {
        ...
        let invetoryItem: InventoryItem = world.read_model((alice, 3));
        ...
        let invetoryItem: InventoryItem = world.read_model((alice, 4));
        ...
        let invetoryItem: InventoryItem = world.read_model((alice, 5));
